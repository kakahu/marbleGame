...
//  project26
//
//  Created by Hu Yang on 25/12/15.
//  Copyright (c) 2015 Hu Yang. All rights reserved.
//
import CoreMotion
import SpriteKit
    ...
    override func update(currentTime: CFTimeInterval) {
        if !gameOver {
            ...
            if let accelerometerData = motionManager.accelerometerData {
                physicsWorld.gravity = CGVector(dx: accelerometerData.acceleartion.y * -50, dy: accelerometerData.acceleration.x * 50)
            }
        #endif
        }
    }
